...
Gem::Specification.new do |gem|
  gem.name          = 'vagrant-openstack-illuin-provider'
  gem.version       = VagrantPlugins::Openstack::VERSION
  gem.authors       = ['Guillaume Giamarchi', 'Julien Vey', 'Paul des Garets']
  gem.email         = ['guillaume.giamarchi@gmail.com', 'vey.julien@gmail.com', 'paul.des-garets@illuin.tech']
  ...
  gem.homepage      = 'https://github.com/illuin-tech/vagrant-openstack-provider'
  gem.license       = 'MIT'
